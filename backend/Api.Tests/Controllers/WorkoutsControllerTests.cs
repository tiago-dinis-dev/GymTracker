...
public class WorkoutsControllerTests
{
    ...
    public WorkoutsControllerTests()
    {
        ...
        var getWorkoutInProgressHandler = new GetInProgressWorkoutHandler(_workoutRepo.Object, _userContext.Object);
        _controller = new WorkoutsController(createHandler, completeHandler, getByIdHandler, getWorkoutInProgressHandler);
    }
